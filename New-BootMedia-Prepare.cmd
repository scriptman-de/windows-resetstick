...
set DRIVE=%~dp0
set FOLDER=WinPE_amd64_PrepareBootMedia
...
copy Stage1-Prepare\startnet-prepare.cmd "%MediaFolder%\mount\Windows\System32\startnet.cmd"

Dism /Image:%MediaFolder%\mount /Add-Driver /Driver:%DRIVE%\Drivers\*.inf /recurse
